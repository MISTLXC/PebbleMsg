...
import { setUiTheme } from "@/lib/api";
...
export type SettingsTab = "accounts" | "general" | "proxy" | "appearance" | "privacy" | "rules" | "remoteWrites" | "translation" | "shortcuts" | "popup" | "cloudSync" | "about";
...
export const useUIStore = create<UIState>((set) => ({
  ...
  setTheme: (theme) => {
    ...
    void setUiTheme(resolveTheme(theme)).catch(() => {});
    set({ theme });
  },
