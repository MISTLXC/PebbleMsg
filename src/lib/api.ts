...
export async function showTestPopup(): Promise<void> {
  return invoke<void>("show_test_popup");
}

export async function updatePopupConfig(config: PopupConfig): Promise<void> {
  return invoke<void>("update_popup_config", { config });
}

export async function getPopupConfig(): Promise<PopupConfig> {
  return invoke<PopupConfig>("get_popup_config");
}

export async function closePopup(messageId: string): Promise<void> {
  return invoke<void>("close_popup", { messageId });
}

export async function setUiTheme(theme: string): Promise<void> {
  return invoke<void>("set_ui_theme", { theme });
}
