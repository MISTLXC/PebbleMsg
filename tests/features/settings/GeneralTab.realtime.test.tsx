  ...
  useTranslation: () => ({
    t: (key: string, fallback?: string) => {
      const labels: Record<string, string> = {
        ...
        "settings.popupNotifications": "Popup Notifications",
        "settings.enablePopupNotifications": "Enable popup notifications for new mail",
...
describe("GeneralTab realtime mode", () => {
  ...
  it("shows the persisted popup notification state and updates it through the UI store", () => {
    render(<GeneralTab />);

    const checkbox = screen.getByRole("checkbox", { name: "Enable popup notifications for new mail" });
